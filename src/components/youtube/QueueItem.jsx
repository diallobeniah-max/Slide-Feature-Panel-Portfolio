...
import { Trash2, ChevronDown, ChevronUp, Download, Scissors, Check, AlertCircle } from 'lucide-react';
import { Card, Button, Badge } from '../ui';
import { formatTime, formatBytes, extractVideoId } from './youtubeUtils';
...
export default function QueueItem({ item, onRemove, onUpdate, onDownload, onDownloadSubtitles }) {
